...
class HTTPMusicbrainzClientTest {
    ...
    void getArtist() throws Exception {
        ...
        assertEquals("Lovejoy", artist.get().getName());
    }
    ...
    void getRecording() throws Exception {
        ...
        assertEquals("Call Me What You Like", recording.get().getTitle());
    }
    ...
    void getRelease() throws Exception {
        ...
        assertEquals("Call Me What You Like", release.get().getTitle());
    }
    ...
    void getReleaseGroup() throws Exception {
        ...
        assertEquals("Call Me What You Like", releaseGroup.get().getTitle());
    }
    ...
    void getTrack() throws Exception {
        ...
        assertEquals("1", track.get().getNumber());
    }
    ...
    void getWork() throws Exception {
        ...
        assertEquals("Call Me What You Like", work.get().getTitle());
    }
}