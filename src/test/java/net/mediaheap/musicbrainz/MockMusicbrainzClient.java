...
public class MockMusicbrainzClient implements MusicbrainzClient {
    @Override
    public Artist getArtist(@NonNull String id) {
        if ("deefd67b-c917-4b0d-ab48-c5af7f92cd82".equals(id)) {
            return Artist.of(LocalDate.now().toString(), id, "Lovejoy", "Lovejoy", "2021 indie band with Wilbur Soot", "", null, "9d5dd675-3cf4-4296-9e39-67865ebee758", "8a754a16-0027-3a29-b6d7-2b40ea0481ed", null, "2021-05-08", null, "false");
        } else {
    ...
    @Override
    public Recording getRecording(@NonNull String id) throws Exception {
    ...
    @Override
    public Release getRelease(@NonNull String id) throws Exception {
    ...
    @Override
    public ReleaseGroup getReleaseGroup(@NonNull String id) throws Exception {
    ...
    @Override
    public Track getTrack(@NonNull String releaseId, @NonNull String trackId) throws Exception {
    ...
    @Override
    public Work getWork(@NonNull String id) throws Exception {
